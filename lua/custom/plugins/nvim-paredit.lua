		...
		config = function()
			...
			paredit.setup({
				...
				keys = {
					...
					[">)"] = { paredit.api.slurp_forwards, "Paredit: Slurp forwards" },
					[">("] = { paredit.api.barf_backwards, "Paredit: Barf backwards" },

					["<)"] = { paredit.api.barf_forwards, "Paredit: Barf forwards" },
					["<("] = { paredit.api.slurp_backwards, "Paredit: Slurp backwards" },

					[">e"] = { paredit.api.drag_element_forwards, "Paredit: Drag element right" },
					["<e"] = { paredit.api.drag_element_backwards, "Paredit: Drag element left" },

					[">p"] = { paredit.api.drag_pair_forwards, "Paredit: Drag element pairs right" },
					["<p"] = { paredit.api.drag_pair_backwards, "Paredit: Drag element pairs left" },

					[">f"] = { paredit.api.drag_form_forwards, "Paredit: Drag form right" },
					["<f"] = { paredit.api.drag_form_backwards, "Paredit: Drag form left" },

					["<localleader>o"] = { paredit.api.raise_form, "Paredit: Raise form" },
					["<localleader>O"] = { paredit.api.raise_element, "Paredit: Raise element" },
